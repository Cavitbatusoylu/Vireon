...
$srcPath = Join-Path $root 'src\Vireon.PresentationLayer\wwwroot\images\vireon-logo-transparent-new.png'
$outDir = Join-Path $root 'src\Vireon.PresentationLayer\wwwroot\images\pwa'
