...
namespace Vireon.PresentationLayer.Controllers
{
    ...
    public class UsersController : ControllerBase // Kullanıcı işlemlerini yöneten API denetleyicisi
    {
        ...
        // GET: api/users — Kullanıcı rehberi (karşı taraf ismini göstermek için); e-posta gibi PII döndürmez
        [HttpGet]
        ...
        // GET: api/users/{id} — ID ile kullanıcı getirir (sadece kendisi veya admin)
        [HttpGet("{id}")]
        ...
        // POST: api/users/logout — Oturumu sonlandırır
        [HttpPost("logout")]
